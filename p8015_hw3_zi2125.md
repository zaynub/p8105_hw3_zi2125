...
average max temps in July as is expected. It is also interesting to note
that there are some weather stations that don’t have temperature data.
There are no observable outliers in this graph.
